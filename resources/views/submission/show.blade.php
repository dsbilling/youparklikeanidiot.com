        ...
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>{!! __('parking.sent_in', ['url' => route('user.show', $user['uuid']), 'name' => ($user['anon'] ? $user['uuid'] : $user['username']), 'created_at' => \Carbon\Carbon::parse($created_at), 'human_time' => \Carbon\Carbon::parse($created_at)->diffForHumans()]) !!}</p>

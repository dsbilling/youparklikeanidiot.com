...
@section('content')
<div class="jumbotron">
	<h1>Lei av folk som parkerer som en <em><a href="{{ url('/info/om-oss') }}">idiot</a></em>?</h1>
	<p class="lead">Du er ikke alene, det er mange der ute som irriterer seg over slikt. Her kan du finne haugevis med folk som har parkert som en <em><a href="{{ url('/info/om-oss') }}">idiot</a></em>.</p>
	...
	<p class="lead">Ønsker du å vise <em><a href="{{ url('/info/om-oss') }}">idioten</a></em> at de har parkert feil? Da kan du laste ned PDF-en for å printe ut og henge på ruta.</p>
	<p class="lead">
